      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center mb-20">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10 order-2 md:order-1 animate-on-scroll">
            ...
            <a href="#servicios" className="inline-flex items-center text-primary border-b-2 border-primary font-medium hover:text-primary-light hover:border-primary-light transition duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-neutral-lightest p-8 rounded-lg shadow-sm animate-on-scroll card-hover">
        ...
        <div className="mt-20 pt-16 border-t border-neutral-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center animate-on-scroll">
